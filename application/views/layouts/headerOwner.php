    ...
    <nav class="navbar" >
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <p><a href="<?php echo site_url('owner/OfficeAllocationController/openAllocations');?>">Open AdHoc Allocations</a></p>  
                            <p><a href="<?php echo site_url('owner/OfficeAllocationController/closedAllocations');?>">Closed AdHoc Allocations</a></p>  
                            <p><a href="<?php echo site_url('owner/AllocationByManagerController/closedAllocations');?>">Closed Office Allocations</a></p>  
                        </div>
                    </div> 
                </a>
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        <span class="navbar-brand">Expenses Details 
                            <i class="fa fa-caret-down"></i>
                        </span>
                        <div class="dropdown-content">
                            <p><a href="<?php echo site_url('owner/ExpensesController/expensesDetails');?>">Pending Expenses</a></p> 
                            ...
                            <p><a href="<?php echo site_url('owner/OfficeAllocationController/billClearance');?>">Residual Bill Clearing</a></p>    
                             <p><a href="<?php echo site_url('owner/OfficeAllocationController/empApproval');?>">Employee Approval</a></p>
                             <p><a href="<?php echo site_url('owner/ExpensesController/nonCashDebitCreditApproval');?>">Non Cash Debit/Credit Approval</a></p>
                        </div>
                    </div> 
                </a>
