...
<head>
    ...
    <title>Smart | Distributor | Owner</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="dropdown" href="<?php echo site_url('DashbordController');?>"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand"><i class="fa fa-dashboard"></i>
                    </span>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand">Allocation 
                      <i class="fa fa-caret-down"></i>
                    </span>
                    <div class="dropdown-content">
                      <p><a href="<?php echo site_url('AllocationByManagerController');?>">Create Allocation</a></p>                   
                      <p><a href="<?php echo site_url('AllocationByManagerController');?>">Open Allocation</a></p>  
                    <p><a href="<?php echo site_url('AllocationByManagerController');?>">Close Allocation</a></p>  
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      ...
                      <p><a href="<?php echo site_url('CashAndChequeController');?>">Cheque Deposit slip</a></p> <p><a href="<?php echo site_url('CashAndChequeController');?>">Cheque Reconciliation</a></p> 
                      <p><a href="<?php echo site_url('CashAndChequeController');?>">Bounced Cheques</a></p>  
                      <p><a href="<?php echo site_url('CashAndChequeController/DesktopBill');?>">Cheque Register</a></p> 
                    </div>
                  </div> 
                </a>
                 <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand">CashBook
                      <i class="fa fa-caret-down"></i>
                    </span>
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Current Day Book</a></p>
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Past Day Book</a></p>    
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Peroid Day Book</a></p>
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand">DiliverySlip
                      <i class="fa fa-caret-down"></i>
                    </span>
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">New Tansaction</a></p>      
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Outstanding Bill</a></p> <p><a href="<?php echo site_url('CashAndChequeController');?>">Retailer Outstanding </a></p> 
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Report</a></p>  
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Cash Receipt</a></p>
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Sale Return</a></p> 
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">View Stock</a></p>
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Billwise Details</a></p>
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand">SaleReturn
                      <i class="fa fa-caret-down"></i>
                    </span>
                    <div class="dropdown-content">
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand">NonAllocationBill
                      <i class="fa fa-caret-down"></i>
                    </span>
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('');?>">Tagged Bill</a></p>
                        <p><a href="<?php echo site_url('');?>">CD sale Bill</a></p>
                        <p><a href="<?php echo site_url('');?>">CD Adjustment Bills</a></p>
                    </div>
                  </div> 
                </a>
                 ...
                 <div class="dropdown">
                  ...
                  <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand">AcntEntries
                      <i class="fa fa-caret-down"></i>
                    </span>
                    <div class="dropdown-content">
