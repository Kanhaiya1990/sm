...
<head>
    ...
    <title>Smart | Distributor |Delivery Man</title>
    <!-- Favicon-->
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">                 
                      <p><a href="<?php echo site_url('fieldStaff/FieldStaffController/OpenAllocation');?>">Open Allocation</a></p>  
                    <p><a href="<?php echo site_url('MakeBillwiseController');?>">Close Allocation</a></p>  
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('SalesReturnController');?>">Sales Return Details</a></p>      
                        <p><a href="<?php echo site_url('SalesReturnController');?>">USR Item Details</a></p>
                        <p><a href="<?php echo site_url('SalesReturnController');?>">USR Bills</a></p>  
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
