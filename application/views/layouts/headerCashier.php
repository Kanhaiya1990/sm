...
<head>
    ...
    <title>Smart | Distributor |CASHIER</title>
    <!-- Favicon-->
               ...
               <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <p><a href="<?php echo site_url('cashier/CashAndChequeController/');?>">New Entry</a></p>    
                            <p><a href="<?php echo site_url('cashier/CashAndChequeController/DesktopBill');?>">Cheque Deposit Slip</a></p><p><a href="<?php echo site_url('cashier/CashAndChequeController/ChequeReconcilation');?>">Cheque Reconciliation</a></p> 
                            <p><a href="<?php echo site_url('cashier/CashAndChequeController/BounceCheques');?>">Bounced Cheques</a></p>  
                            <p><a href="<?php echo site_url('cashier/CashAndChequeController/CheckRegister');?>">Cheque Register</a></p> 
                        </div>
                    </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('cashier/CashBookController/index');?>">Current Day Book</a></p>
                        <p><a href="<?php echo site_url('cashier/CashBookController/PastDayBook');?>">Past Day Book</a></p>    
                        <p><a href="<?php echo site_url('cashier/CashBookController/PeroidDayBook');?>">Peroid Day Book</a></p>
                        <p><a href="<?php echo site_url('cashier/CashBookController/EVauchers');?>">E-Vauchers</a></p>  
                        <p><a href="<?php echo site_url('cashier/CashBookController/AccountingEntries');?>">Accounting Entries</a></p> 
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    <span class="navbar-brand">Delivery Slip
                      <i class="fa fa-caret-down"></i>
                    </span>
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('cashier/DeliverySlipController/OutstandingBill');?>">Tagged Bill</a></p>
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('CashAndChequeController');?>">Tagged Bill</a></p>
                    </div>
                  </div> 
                </a>
