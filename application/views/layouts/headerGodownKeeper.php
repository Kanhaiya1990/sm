...
<head>
    ...
    <title>Smart | Distributor |GodownKeeper</title>
    <!-- Favicon-->
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                      <p><a href="<?php echo site_url('godownkeeper/GodownKeeperController/OpenAllocation');?>">Open Allocation</a></p>  
                    <p><a href="<?php echo site_url('');?>">Close Allocation</a></p>  
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('');?>">New Tansaction</a></p>      
                        <p><a href="<?php echo site_url('');?>">Outstanding Bill</a></p> <p><a href="<?php echo site_url('');?>">Retailer Outstanding </a></p> 
                        <p><a href="<?php echo site_url('');?>">Report</a></p>  
                        <p><a href="<?php echo site_url('');?>">Cash Receipt</a></p>
                        <p><a href="<?php echo site_url('');?>">Sale Return</a></p> 
                        <p><a href="<?php echo site_url('');?>">View Stock</a></p>
                        <p><a href="<?php echo site_url('');?>">Billwise Details</a></p>
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                 <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <p><a href="<?php echo site_url('godownkeeper/SrController');?>">Sales Return Details</a></p>
                       
                       <p><a href="<?php echo site_url('godownkeeper/SrController/usr');?>">USR Bills</a></p>  
                    </div>
                  </div> 
                </a>
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
