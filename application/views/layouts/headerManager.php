    	...
    	<div class="container-fluid">
    		<div class="navbar-header">
    			...
    			<a class="dropdown" href="<?php echo site_url('DashbordController');?>"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					<span class="navbar-brand">Dashboard 
    					</span>
    				</div> 
    			</a>
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					<span class="navbar-brand">Allocations 
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        <span class="navbar-brand">Bill Management
                            <i class="fa fa-caret-down"></i>
                        </span>
                        <div class="dropdown-content">
                           <p><a href="<?php echo site_url('AdHocController/adhocBills');?>">Add New Bills</a></p> 
                            ...
                            <p><a href="<?php echo site_url('AdHocController/officeAdjustmentBills');?>">Office Adjustment Bills</a></p> 
                             <!-- <p><a href="<?php echo site_url('AdHocController/unalocatedAdHocBills');?>">Non Allocated AdHoc Bills</a></p>   -->

                            <!-- <p><a href="<?php echo site_url('manager/OfficeAllocationController');?>">Office Allocations</a></p>    -->
                        </div>
                    </div> 
                </a>
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
                            ...
                            <p><a href="<?php echo site_url('CashAndChequeController/chequeDepositSlipTransactions');?>">Cheque Deposit Transactions</a></p>
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
                            ...
                            <p><a href="<?php echo site_url('manager/CashBookController/IncomeExpense');?>">Current Day Book
                            </a></p>  
                ...
                <a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
                    <div class="dropdown">
                        <span class="navbar-brand">Provisional Debits
                            <i class="fa fa-caret-down"></i>
                        </span>
                        <div class="dropdown-content">
                            <!-- <p><a href="<?php echo site_url('SrController/usr');?>">USR Bills</a></p>  -->
    			...
    			<a class="dropdown" href="#"  data-toggle="collapse" data-target=".nav-collapse">
    				<div class="dropdown">
    					...
    					<div class="dropdown-content">
    						<p><a href="<?php echo site_url('manager/EmployeeController/employeeLedger');?>">Ledger</a></p>         
    						<!-- <p><a href="<?php echo site_url('');?>">Salary slip</a></p> -->
