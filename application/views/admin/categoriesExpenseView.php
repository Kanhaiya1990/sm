...
<section class="col-md-12 box" style="height: auto;overflow-y: scroll;">
  ...
  <div class="modal fade" id="updateExpenselimitModal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <!-- <button type="button" class="close" data-dismiss="modal">&times;</button> -->
            <h4 class="modal-title">Change Expenses Category</h4>
          </div>
          <div id="expense_limitid" class="modal-body">
...
<script type="text/javascript">
    $(document).on('click','#expense_limit_id',function(){
         var id=$(this).attr('data-id');
         $.ajax({
            url : "<?php echo site_url('admin/CategoriesController/loadExpensesCategory');?>",
            method : "POST",
