                            ...
                            <div class="table-responsive">
                              <p id="res"></p>
                                <table class="table" data-page-length='100'>
                                    ...
                                    <tbody>
                                        <tr id="sr_rep">
                                            <td>Maximum Threashold limit for Residual Bill Clearing</td>
                                            <td>
                                              <input type="text" id="market_amount" class="form-control" value="<?php echo $expenseLimit[3]['expenseLimit']; ?>" style="width:100px">
                                            </td>
                                             <td>
