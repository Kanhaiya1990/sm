                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <h2>
                                <p align="right">
                                  <a href="<?php echo site_url('admin/CompanyController/Add');?>">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" data-page-length='100'>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['reportSW']; ?></td>
                                            <td>
                                                <a href="<?php echo base_url().'index.php/admin/CompanyController/load/'.$data['id']; ?>">
...
.then((willDelete) => {
  if (willDelete) {
    $.ajax({
        url: "<?php echo site_url('admin/CompanyController/delete');?>",
        type: "post",
        data: {'id':id},
        success: function (response) {
          ...
          var URL = "<?php echo site_url('admin/CompanyController');?>";
