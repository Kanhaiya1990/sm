            ...
            <div class="row clearfix" id="page">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <h2>Other Adjustment Bills</h2>
                        <a href="<?php echo site_url('AdHocController/otherAdjustmentBills');?>">
                        ...
                        <div class="row m-t-20">
                                ...
                                <div class="col-md-12">
                                   <form method="post" role="form" action="">
                                      ...
                                      <div class="col-md-3">
                                        <button type="submit" class="btn m-t-20 btn-primary btnStyle"><i class="material-icons">search</i>Search</button>
                                      </div>
                                    </form>
