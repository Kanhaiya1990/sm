                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header flex-div">
                            ...
                            <a href="<?php echo site_url('AdHocController/debitNoteBillsHistory');?>">
                            <button class="btn btn-xs bg-primary btnStyle margin"><i class="material-icons"> refresh</i>    </button></a>
                        ...
                        <div class="row m-t-20">
                                ...
                                <div class="col-md-12 cust-tbl">
                                    <form method="post" role="form" action="">
                                      ...
                                      <div class="col-md-3">
                                        <button type="submit" class="btn m-t-20 btnStyle btn-primary"><i class="material-icons">search</i>Search</button>
                                      </div>
                                    </form>
                                   ...
                                   <table class="table table-bordered dataTable js-exportable cust-tbl" data-page-length='100'>
                                    ...
                                    <tbody>
                                            ...
                                            foreach ($officeAdjustmentBills as $data) 
                                            {
                                              ...
                                              $remarks=$this->AllocationByManagerModel->getRemarksById('billpayments',$data['id']);
                                               $no++; 
                                            ...
                                            <?php } ?>
                                                ...
                                                <td align="right"><?php echo number_format($data['debitNoteAmount']); ?></td>
                                            ...
                                            data-placement="left" title="Remark" data-content="<?php if(!empty($remarks)){ for($i=0;$i<count($remarks);$i++){ echo $remarks[$i]['tallyRemark'].',  ';  } } ?>">
