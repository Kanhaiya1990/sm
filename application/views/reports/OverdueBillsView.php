            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="post" role="form" action="<?php echo site_url('reports/ReportController/OverdueBillsReport');?>"> 
                                <div class="row clearfix">
                                <?php 
                                    ...
                                    <div class="col-md-12 cust-tbl"> 
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" id="fromDate" name="fromDate" class="form-control" value="<?php echo $first_date;?>" readonly required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" id="toDate" name="toDate" class="form-control" value="<?php echo $last_date ?>" readonly required>
                                                </div>
                                            </div>
                                        </div>
