        ...
        <div class="card">
            <div class="body">
                 <?php echo form_open('UserAuthentication/user_login_process'); ?> 
                    ...
                    <?php
                        echo '<p style="color:red" >'.$logout_message.'</p>';?>
                    <!-- </div> -->
                        <?php
                    }
                ...
                <div class="col-md-12">
                    <div class=" input-group">
                            ...
                            <div class="col-md-4 form-line">
                                <input type="text" autocomplete="off" onkeypress="return numbersonly(this, event);" class="form-control" id="mobile" name="mobile" placeholder="Enter registered mobile number" required>
...
<script type="text/javascript">
    $(document).on('click','#save_id_pass',function(){
        ...
        {
            type:"post",
            url: "<?php echo base_url(); ?>index.php/UserAuthentication/saveCreatedPassword",
