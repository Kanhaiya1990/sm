      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
            <center><h4 class="modal-title">Upload Products File</h4></center>
          </div>
          <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <a href="<?php echo site_url('DeliverySlipController/paginationProducts');?>">
      ...
      if (willDelete) {
        $.ajax({
            ...
            success: function (response) {
              ...
              var URL = "<?php echo site_url('DeliverySlipController/paginationProducts');?>";
        ...
        if(productCompany==="" || productName==="" || productCode==="" || productMrp==="" || productUnitOne==="" || productUnitTwo==="" || productUnitThree===""){
            ...
            $.ajax({
                ...
                success: function (data) {
                  alert(data);
                    // $('#recStatus').html(data);
                    window.location.href="<?php echo base_url();?>index.php/DeliverySlipController/paginationProducts";
                }  
            });
        }
    });
...
<script type="text/javascript">
    var sendRequest = function(){
      ...
      window.location.href = '<?=base_url('index.php/DeliverySlipController/paginationProducts')?>?query='+searchKey+'&limitRows='+limitRows+'&orderField='+curOrderField+'&orderDirection='+curOrderDirection;
    }
